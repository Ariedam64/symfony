 ...
 */
final class Version20210110144608 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, entreprises_id INT DEFAULT NULL, intitule VARCHAR(25) NOT NULL, mission VARCHAR(50) NOT NULL, adresse_mail VARCHAR(25) NOT NULL, INDEX IDX_C27C9369A70A18EC (entreprises_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
